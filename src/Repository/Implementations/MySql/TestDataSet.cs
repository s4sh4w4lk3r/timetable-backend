...
namespace Repository.Implementations.MySql
{
    public class TestDataSet
    {
            ...
            var cabinets = new List<Cabinet>()
        {
            ...
            new Cabinet(3, "Москва", $"{rand.Next()}"),
            ...
            var users = new List<User>()
        {
            ...
            var conn = new MySqlConnection("server=localhost;user=root;password=root;database=timetable;");
            var context = new MySqlDbContext(conn);
